...
actions. \karen{Here we say we divide a motion to actions. Later in
  the overview, we say we assemble actions to make a motion. Not a big
  deal, but it might be good to be consisten.} These actions include placing a hand or foot through an opening,
