...
autonomously based on the state of the cloth \new{and effectively make incremental progress toward the goal in a diverse set of dressing situations}.
\alex{These methods do use the state of the cloth to make decisions, but rely on assumptions such as easy relative motion of the cloth and body, no snags or occlusions, a clean flux field without singularities, user keyframes in the alignment process, etc.}
