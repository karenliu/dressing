...
visible to the tip of the hand.  When real people dress themselves, we
speculate that much of the feedback based on the cloth position is due to
tactile feedback, instead of using visual information.
...
system that would analyze a garment and form a plan of actions to put on
